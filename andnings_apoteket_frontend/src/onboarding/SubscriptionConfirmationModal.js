      ...
      >
        <ScrollView contentContainerStyle={styles.scrollViewContent}>
          <View style={styles.modalHeader}>
            <EnhancedText style={styles.headerTitle}>
              Andningsapoteket
            </EnhancedText>
            <TouchableOpacity onPress={onClose} style={styles.cancelButton}>
              <EnhancedText style={styles.cancelButtonText}>
                Avbryt
              </EnhancedText>
            </TouchableOpacity>
          </View>
          ...
          <View style={styles.contentContainer}>
            <View style={styles.subscriptionInfo}>
              ...
              <View>
                <EnhancedText style={styles.subscriptionName}>
                  {subscriptionDetails.name}
                </EnhancedText>
                <EnhancedText style={styles.subscriptionDescription}>
                  Andningsapoteket — Premium
                </EnhancedText>
              </View>
            </View>
            ...
            <View style={styles.paymentTabsContainer}>
              <TouchableOpacity
                style={[
                  styles.paymentTab,
                  paymentMethod === "appleId" && styles.activePaymentTab,
                ]}
              ...
              >
                <EnhancedText
                  style={[
                    ...
                    paymentMethod === "appleId" && styles.activePaymentTabText,
                  ]}
                >
                  Apple ID
                </EnhancedText>
              ...
              <TouchableOpacity
                style={[
                  styles.paymentTab,
                  paymentMethod === "creditCard" && styles.activePaymentTab,
                ]}
            ...
            <View style={styles.detailsContainer}>
              <View style={styles.detailRow}>
                ...
                <EnhancedText style={styles.detailValue}>
                  Endast för testning. Du kommer inte att debiteras för detta
                  köp.
                </EnhancedText>
              </View>
              <View style={styles.detailRow}>
              ...
              <View style={styles.detailRow}>
                ...
                <EnhancedText style={styles.detailValue}>
                  {subscriptionDetails.trial} Dagar Gratis
                </EnhancedText>
              </View>
              <View style={styles.detailRow}>
            ...
            {paymentMethod === "appleId" ? (
              <View style={styles.confirmationContainer}>
                ...
                <EnhancedText style={styles.confirmText}>
                  Bekräfta med Touch ID
                </EnhancedText>
              </View>
            ) : (
